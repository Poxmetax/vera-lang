...
**Date:** 2026-07-19 · **Author:** AI agent (single session) · **Location:** `bench/` (self-contained; imports no external runtime)
...
Run from `bench/` with `python` = CPython 3.13.13. Raw logs in `logs/`.
