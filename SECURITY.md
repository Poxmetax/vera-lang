...
contributions that pull in private trading systems, secrets, or unrelated paths
...
- Attach credentials or `.env` contents
...
maintainer review, nor does it cover work outside this repository's scope.
