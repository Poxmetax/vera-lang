...
// [GAP-D2] Deserialize is additive (serialization unchanged): durable
// FixPatch records must round-trip from the on-disk store.
...
/// toolchain/solver version): see INV-2 keying / GAP-D2.
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct FixPatch {
